...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Salman Umer",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Salman Umer*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://cutewallpaper.org/21x/hianxltb9/Awesome-PowerPoint-Backgrounds-Templates-for-PowerPoint.jpg");
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"],
                       ...
                       styles={"nav-link": {"font-size": "30px", "text-align": "centre", "margin": "0px", "--hover-color": "#5A86D5"},
                               "icon": {"font-size": "30px"},
                               "container" : {"max-width": "6000px"},
                               "nav-link-selected": {"background-color": "#A0E59"}})
